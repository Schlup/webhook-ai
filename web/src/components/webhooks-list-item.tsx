...
export function WebhooksListItem() {
    return (
        <div className="rounded-lg transition-colors duration-150 hover:bg-zinc-700/30 cursor-pointer group">
            <div className="flex items-start gap-3 px-4 py-2.5">
                ...
                <IconButton icon={<Trash2Icon className="size-3.5 text-zinc-400" />} className="opacity-0 transition-opacity group-hover:opacity-100" />
            </div>
        </div>
    )
}